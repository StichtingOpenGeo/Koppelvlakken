...
KV55_ERROR = """<?xml version="1.0"?><DRIS_55><SubscriberID>openOV</SubscriberID><Version>0.0.2</Version><DossierName>KV55</DossierName><Request><TimingPoint><TimingPointCode>%(timingpointcode)s</TimingPointCode></TimingPoint><Error>%(error)s</Error></Request></DRIS_55>"""
KV55_REP = """<?xml version="1.0"?><DRIS_55><SubscriberID>OpenOV</SubscriberID><Version>0.0.2</Version><SendTimestamp>%(sent)s</SendTimestamp><License>http://creativecommons.org/publicdomain/zero/1.0/</License><Request><RequestTimestamp>%(request)s</RequestTimestamp><TimingPoint><TimingPointCode>%(tpc)s</TimingPointCode>%(trips)s</TimingPoint></Request></DRIS_55>"""
KV55_TRIP = """<Trip><OperatingDate>%(operdate)s</OperatingDate><DataOwnerCode>ARR</DataOwnerCode><LinePlanningNumber>%(linenumber)s</LinePlanningNumber><DestinationName>(%(linenumber)s) %(linename)s</DestinationName><TargetDepartureTime>%(target)s</TargetDepartureTime><ExpectedDepartureTime>%(expected)s</ExpectedDepartureTime></Trip>"""
