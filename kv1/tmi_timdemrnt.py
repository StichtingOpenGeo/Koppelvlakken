class tmi_timdemrnt():
    ...
    def parse(self, version, implicit, data_owner_code, elements):
        line_planning_number, journey_pattern_code, time_demand_group_order, timing_link_order, user_stop_begin, user_stop_end, total_drive_time, drive_time, expected_delay, lay_over_time, stop_wait_time, minimum_stop_time = elements
        self.data.append([version, implicit, data_owner_code, line_planning_number, journey_pattern_code, time_demand_group_order, timing_link_order, user_stop_begin, user_stop_end, total_drive_time, drive_time, expected_delay, lay_over_time, stop_wait_time, minimum_stop_time])
