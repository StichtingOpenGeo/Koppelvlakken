from helper import time32, wheelchair, boolsql, daytype2bitstring
...
class tmi_pujo():
    ...
    def parse(self, version, implicit, data_owner_code, elements):
        ...
        daytype = str(daytype2bitstring(day_type))
        ...
        self.data.append([version, implicit, data_owner_code, timetable_version_code, organizational_unit_code, period_group_rode, specific_day_code,
                          daytype, line_planning_number, journey_number, time_demand_group_code, journey_pattern_code,
